...
\draw[fill=mnmP2] (xL/yB) rectangle node[white,below] {$p$}  (xR/yA);
\draw[fill=mnmN1] (xBL/yDopeB) rectangle node[white,right] {$n^{+}$} (xBR/yA);
\draw[fill=mnmP0] (xEL/yDopeA) rectangle node[white] {$p^{++}$} (xER/yA);
\draw[fill=mnmP0] (xCL/yDopeA) rectangle node[white] {$p^{++}$} (xCR/yA);
\draw[fill=mnmP0] (xBuL/yDopeC) rectangle node[white] {\small $p^{++}$} (xBuR/yB);
