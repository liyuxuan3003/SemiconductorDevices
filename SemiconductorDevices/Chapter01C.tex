...
% 由于半导体器件物理中更常用的是电流密度$J$，而电流密度$J$本质是单位面积上的电流，因此，当我们提到“电阻$R$、电容$C$、电荷$Q$”等电路量时，实际上，我们都是指单位面积上的“电阻$R'$、电容$C'$，电荷$Q'$\;”，加撇以示区分。之后将默认这一点，不再强调单位面积。
...
\begin{Proof}
    根据\fancyref{def:二极管的势垒电容}
    \begin{Equation}&[1]
        C_j=\dv{Q}{V_R}
    \end{Equation}
    将$\dd{Q}=eAN_d\dd{x_n}$代入\xrefpeq{1}
    \begin{Equation}&[2]
