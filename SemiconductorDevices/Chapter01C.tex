...
\begin{BoxFormula}[二极管的扩散电导]
    二极管的扩散电导可以表示为
    \begin{Equation}
        g_d=\frac{eI_{DQ}}{\kB T}
    \end{Equation}
\end{BoxFormula}

\begin{Proof}
    根据\fancyref{fml:PN结二极管的特性方程}
    \begin{Equation}&[1]
        I_D=I_s\qty[\exp(\frac{eV_a}{\kB T})-1]
    \end{Equation}
    假定$V_a$较大，忽略$-1$
...
\begin{Figure}[扩散电容的来源]
    \includegraphics[width=0.95\linewidth]{build/Chapter01C_01.fig.pdf}
\end{Figure}
...
\begin{Figure}[二极管的小信号等效电路]
    \includegraphics{build/Chapter01C_02.fig.pdf}
\end{Figure}
